...
class Main:
    ...
    def __init__(self):
        ...
        self.font2 = font2
        self.background1 = pygame.image.load("./assets/bg.gif")    # de l'initialisation de base de Pygame.
        self.background1 = pygame.transform.scale(self.background1, (1280, 720))
        self.background2 = pygame.image.load("./assets/bg2.gif")
        self.background2 = pygame.transform.scale(self.background2, (1280, 720))
        self.click = False                                                   #
        self.flag = False    
        self.isPlay = False                                                #
        self.lvl_sound = 0.2
        self.start_img = pygame.image.load('./assets/start_btn.png').convert_alpha()
    ...
    def main_menu(self):       
        ...
        while running:
            ...
            self.draw_text('Alpha 0.0.1', self.font2, (255, 255, 255), self.screen, 1020, 660)

            start_button = button.Button(540, 200, self.start_img, 0.8)
            exit_button = button.Button(555, 320, self.exit_img, 0.8)
